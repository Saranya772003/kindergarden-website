            ...
            <form method="post" action="assets/php/actions.php?signup">
                ...
                <div class="d-flex">
                    <div class="form-floating mt-1 col-6 ">
                        <input style="margin:5px;" type="text" name="first_name" value="<?=showFormData('first_name')?>" class="form-control rounded-0" placeholder="username/email">
                        <label for="floatingInput">first name</label>
                    </div>
                    <div class="form-floating mt-1 col-6">
                        <input style="margin:5px;" type="text" name="last_name" value="<?=showFormData('last_name')?>" class="form-control rounded-0" placeholder="username/email">
